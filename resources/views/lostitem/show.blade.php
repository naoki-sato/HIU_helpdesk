    ...
    <div>
        <form class="form-horizontal" role="form" method="POST" action="{{ url('lost-item').'/'.$data['id']}}">
            ...
            <div class="form-group{{ $errors->has('student_name') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4">
                    <input type="text" class="form-control" id="student_name" placeholder="情報 太郎" name="student_name" value="{{$data['student']['student_name'] or ''}}">
            ...
            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4">
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="電話番号を聞いてください。" value="{{$data['student']['phone_no'] or ''}}">
                    @if ($errors->has('phone'))
                        <span class="help-block">
